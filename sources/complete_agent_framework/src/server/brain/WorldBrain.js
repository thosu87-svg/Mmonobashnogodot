...
export class WorldBrain {
  constructor() {
    ...
    this.agents = [
      ...
      new ResourceAgent(),
      new DungeonAgent(),
      new AntiExploitAgent(),
      new TradingAgent(),
      new GuildAgent(),
      new EventReactionAgent()
    ];
    this.orchestrator = new Orchestrator(this.agents, { maxActionsPerTick: 16 });
  }

  tick(world) {
    return this.orchestrator.process(world, this.blackboard);
  }
}
